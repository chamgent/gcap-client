...
import com.gcap.client.ui.components.ModelSelector
...
fun ChatScreen(
        ...
        Scaffold(
            ...
            topBar = {
                TopAppBar(
                    ...
                    actions = {
                        IconButton(onClick = { showParameterPanel = true }) {
                            Icon(Icons.Default.Settings, contentDescription = "模型参数")
                        }
                    }
                )
            },
            bottomBar = {
                Surface(
                    ...
                    Column(
                        ...
                        // Attached media & files preview chips
                            ...
                            Row(
                                ...
                                attachedImages.forEachIndexed { index, file ->
                                    val (icon, defaultLabel) = when {
                                        file.mimeType.startsWith("image/") -> Pair(Icons.Outlined.AutoAwesome, "图片 ${index + 1}")
                            ...
                            if (uiState.isGenerating) {
                                ...
                                IconButton(
                                    ...
                                    Icon(
                                        ...
                                        tint = if (inputText.isNotBlank() || attachedImages.isNotEmpty()) {
    ...
    if (showParameterPanel) {
        ParameterPanel(
            uiState = uiState,
            viewModel = viewModel,
            onDismissRequest = { showParameterPanel = false }
        )
    }
